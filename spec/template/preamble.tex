...
\lstdefinelanguage [risc-v]{Assembler}{
	morekeywords={ADD, ADDI, SLTI, SLTU, SLTIU, AND, ANDI, OR, ORI, XOR, XORI, SLLI, SRLI, SRAI, SLAI, LUI, AUIPC, SLT, SLL, SRL, SRA, JAL, JALR, BEQ, BNE, BLT, BGE, LW, LH, LB, SW, SH, SB, MUL, MULHSU, DIV},
	sensitive=false,
	morecomment=[l]{;},
}
...
\lstdefinestyle{C++}{
	basicstyle=\fontfamily{inconsolata}\selectfont,
	language=C++,
	aboveskip=3mm,
	belowskip=3mm,
