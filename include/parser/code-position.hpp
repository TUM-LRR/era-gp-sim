...
struct CodePosition
{
    ...
    /**
     * \brief Creates a new CodePosition with the given values (IMPORTANT: y before x coordinate! Because row is more important than column).
     * \param iy The given y position.
     * \param ix The given x position.
     */
    CodePosition(CodeCoordinate iy, CodeCoordinate ix)
        : x(ix), y(iy)
    {}
