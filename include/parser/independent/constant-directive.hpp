...
#ifndef ERASIM_PARSER_INDEPENDENT_CONSTANT_DIRECTIVE_HPP
#define ERASIM_PARSER_INDEPENDENT_CONSTANT_DIRECTIVE_HPP
...
#endif /* ERASIM_PARSER_INDEPENDENT_CONSTANT_DIRECTIVE_HPP */
