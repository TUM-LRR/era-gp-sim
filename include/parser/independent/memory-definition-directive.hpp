...
#ifndef ERASIM_PARSER_INDEPENDENT_MEMORY_DEFINITION_DIRECTIVE_HPP
#define ERASIM_PARSER_INDEPENDENT_MEMORY_DEFINITION_DIRECTIVE_HPP
...
#endif /* ERASIM_PARSER_INDEPENDENT_MEMORY_DEFINITION_DIRECTIVE_HPP */
