...
#ifndef ERASIM_PARSER_INDEPENDENT_SECTION_TRACKER_HPP
#define ERASIM_PARSER_INDEPENDENT_SECTION_TRACKER_HPP
...
#endif /* ERASIM_PARSER_INDEPENDENT_SECTION_TRACKER_HPP */
