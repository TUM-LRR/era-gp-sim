...
#ifndef ERASIM_PARSER_INDEPENDENT_SYMBOL_REPLACER_HPP
#define ERASIM_PARSER_INDEPENDENT_SYMBOL_REPLACER_HPP
...
#endif /* ERASIM_PARSER_INDEPENDENT_SYMBOL_REPLACER_HPP */
