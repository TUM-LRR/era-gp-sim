...
#ifndef ERASIM_PARSER_INDEPENDENT_INTEGER_PARSER_HPP
#define ERASIM_PARSER_INDEPENDENT_INTEGER_PARSER_HPP
...
#endif /* ERASIM_PARSER_INDEPENDENT_INTEGER_PARSER_HPP */
