...
public:
     ...
     * \param labels The associated labels with the command (doesn't make sense with this one!?).
     * \param name The name of the command, might not be equal to the section. It has no meaning for the directive.
    ...
    /**
     * \brief Executes the section directive and sets the compiler section to the corresponding value.
     * \param finalRepresentator The representation to output commands to (unused).
     * \param table The symbol table for symbol storage (unused).
     * \param state The compile state which denotes the current section of the compiler.
     */
