...
#ifndef ERASIM_PARSER_COMMON_COMPILE_ERROR_SEVERITY_HPP
#define ERASIM_PARSER_COMMON_COMPILE_ERROR_SEVERITY_HPP
...
#endif /* ERASIM_PARSER_COMMON_COMPILE_ERROR_SEVERITY_HPP */
