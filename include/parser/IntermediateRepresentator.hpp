...
public:
    ...
    /**
     * \fn IntermediateRepresentator::IntermediateRepresentator(const IntermediateRepresentator& other)
    ...
    /**
     * \fn IntermediateRepresentator::IntermediateRepresentator(IntermediateRepresentator&& other)
    ...
    /**
     * \fn IntermediateRepresentator::operator =(const IntermediateRepresentator& other)
    ...
    /**
     * \fn IntermediateRepresentator::operator =(IntermediateRepresentator&& other)
