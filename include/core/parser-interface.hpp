...
#ifndef ERASIM_CORE_PARSER_INTERFACE_HPP
#define ERASIM_CORE_PARSER_INTERFACE_HPP
...
class ParserInterface : public Proxy<ParsingAndExecutionUnit> {
 public:
  ...
  /**
   * Set the callback which is used to set the final representation in the ui.
   *
   * \param callback std::function<void(const FinalRepresentation &)>
   *
   */
  POST(setFinalRepresentationCallback)
...
#endif /* ERASIM_CORE_PARSER_INTERFACE_HPP */
