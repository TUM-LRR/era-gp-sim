...
#ifndef ERASIM_ARCH_COMMON_ABSTRACT_FACTORY_TYPES_HPP
#define ERASIM_ARCH_COMMON_ABSTRACT_FACTORY_TYPES_HPP
...
#endif /* ERASIM_ARCH_COMMON_ABSTRACT_FACTORY_TYPES_HPP */
