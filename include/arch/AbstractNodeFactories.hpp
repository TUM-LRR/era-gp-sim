...
public:
  ...
  virtual std::shared_ptr<AbstractSyntaxTreeNode> createInstructionNode(const std::string& token) = 0;
...
public:
  ...
  virtual std::shared_ptr<AbstractSyntaxTreeNode> createImmediateNode(const std::vector<bool> numericalValue) = 0;
};
...
public:
  ...
  virtual std::shared_ptr<AbstractSyntaxTreeNode> createRegisterAccessNode(const int registerAdress) = 0;
};
...
public:
  ...
  virtual std::shared_ptr<AbstractSyntaxTreeNode> createArithmeticOperationNode(const int opType) = 0;
};
