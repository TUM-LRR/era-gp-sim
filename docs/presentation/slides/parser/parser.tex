...
\begin{center}
	\begin{tikzpicture}
		...
		\node (opstacktxt) [above = of outstacktxt] {Operator-Stack};
			...
			\uncover<4-14> {
				\node (op_add)[rounded corners=1pt, rectangle, draw = black, right = of opstacktxt] {
					\color<14>[rgb]{1,0,0}$+$
				};
			}
			\uncover<8-12> {
				\node (op_mul)[rounded corners=1pt, rectangle, right = of op_add, draw = black] {
					\color<12>[rgb]{1,0,0}$\cdot$
				};
			}
			\uncover<16-20> {
				\node (op_add2)[rounded corners=1pt, rectangle, draw = black, right = of opstacktxt] {
					\color<20>[rgb]{1,0,0}$+$
				};
			}
			\uncover<2-14> {
				\node (num1)[rounded corners=1pt, rectangle, draw = black, right = of outstacktxt] {
					\color<14>[rgb]{1,0,0}$1$
				};
			}
			\uncover<6-12> {
				\node (num2)[rounded corners=1pt, rectangle, draw = black, right = of num1] {
					\color<12>[rgb]{1,0,0}$2$
				};
			}
			\uncover<10-12> {
				\node (num3)[rounded corners=1pt, rectangle, draw = black, right = of num2] {
					\color<12>[rgb]{1,0,0}$3$
				};
			}
			\uncover<15-20> {
				\node (num6)[rounded corners=1pt, rectangle, draw = black, right = of outstacktxt] {
					\color<20>[rgb]{1,0,0}$7$
				};
			}
			\uncover<18-20> {
				\node (num4)[rounded corners=1pt, rectangle, draw = black, right = of num6] {
					\color<20>[rgb]{1,0,0}$4$
				};
			}
			\uncover<13-14> {
				\node (num5)[rounded corners=1pt, rectangle, draw = black, right = of num1] {
					\color<14>[rgb]{1,0,0}$6$
				};
			}
			\uncover<21-> {
				\node (num10)[rounded corners=1pt, rectangle, draw = black, right = of outstacktxt] {
					$11$
				};
			}
		\end{tikzpicture}
