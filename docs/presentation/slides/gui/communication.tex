\begin{slide}{Kommunikation mit dem Core}
  ...
  \begin{tikzpicture}[auto, node distance=0.75cm and 1.5cm]
  % NODE DEFINITIONS
  ...
  \node (callbackarrow) [draw=black, single arrow,minimum height=1.2cm, minimum width=0.4cm, single arrow, shape border rotate=180] at (1.8,0) {};
  \node[above = 0.2cm of callbackarrow, xshift=-0.1cm] {Callback};

  \node (signalarrow) [draw=black, single arrow,minimum height=1.2cm, minimum width=0.4cm, single arrow, shape border rotate=180] at (-1.68,0) {};
  \node[above = 0.2cm of signalarrow, xshift=0.1cm] {Signal};

  \node (interfacearrow1) [draw=black, single arrow,minimum height=1.2cm, minimum width=0.4cm, single arrow] at (1.68,-1.22) {};

  \node (interfacearrow2) [draw=black, single arrow,minimum height=1.2cm, minimum width=0.4cm, single arrow] at (-1.8,-1.22) {};
