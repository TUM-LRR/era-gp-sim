...
\erasim{} läuft unter Linux, OS X und Windows und wird primär über einen Installer ausgeliefert. Dieser kann unter \url{\dots}\todo{Link zu Website oder Github-Release} heruntergeladen werden. Momentan ist \erasim{} unter Windows nur als 32 Bit Applikation verfügbar.\\
