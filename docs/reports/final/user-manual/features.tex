...
Tasten und die zughörige Kodierung, die in den Speicher geschrieben wird, bietet
...
\begin{figure}
	...
	Pause & 0x01000008 \\
\end{tabular}
	\caption{Liste an Tasten und zugehöriger Kodierung, die in den Speicher
geschrieben wird.\newline Quelle: \url{http://doc.qt.io/qt-4.8/qt.html\#Key-enum}}
	\label{tab:keys}
\end{figure}
...
Klick-Bereich ein und schreibt die x- und y-Koodinate des Klicks relativ zum
Klick-Bereich in den Speicher. Der Klick-Bereich deckt ein Koordinatensystem von
$0$ bis $255$ in beiden Dimensionen ab, unabhängig von der abosluten Größe des
