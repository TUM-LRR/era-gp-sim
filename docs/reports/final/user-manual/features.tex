...
werden, die simuliert werden soll. Diese beeinflusst im Wesentlichen, welche
...
werden. Jeder Makroaufruf kann außerdem über einen dreieckigen Button in
...
Bit$, $32\, Bit$ und $64\, Bit$ zur Auswahl. Dabei wird aber die
