...
\begin{figure}
	...
	\node (guiecetera) [below = of editorcomponent, text width=4cm, align=center] {\dots};
	...
	\node (coreecetera) [below = of parsingandexecutionunit, text width=4cm, align=center] {\dots};
