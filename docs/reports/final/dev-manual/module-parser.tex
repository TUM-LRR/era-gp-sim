...
Abbildung \ref{fig:parser-intermediate}.
...
Eine Übersicht über diesen Prozess bietet Abbildung \ref{fig:parser-overview}.
...
Dateien, welche in Abbildung \ref{fig:parser-further} aufgelistet sind.
