...
gesamte Programm, also außerhalb der TabView wie die Menubar, bezogen werden soll.
...
Für den QML-Teil ist Folgendes zu tun: Im Ordner sollte \texttt{ui/Components} ein
