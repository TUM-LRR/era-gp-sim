...
Informationen besteht, existiert eine weitere Oberklasse \texttt{InformationInterface}.
Von ihr sind wiederum die konkreten Informationsklassen abgeleitet. Nennenswert
dabei ist die \texttt{ExtensionInformation} Klasse, die ein Modul in unserer
modularen Auffassung einer Architektur widerspiegelt. Ein finales
\texttt{Architecture} Modul besteht schließlich aus einem ExtensionInformation
Objekt, welches mit allen Erweiterungen vereint wurde.
