...
\begin{itemize}
	...
	\item Die einzelnen Aufgaben werden isoliert in einer \emph{Feature}-Branch bearbeitet.
...
Wir nutzen \emph{Github}\footnote{\url{https://github.com/}} as Hosting-Dienst
...
Verfügung gestellten Mittel, Nutzer sichtbare Nachrichten übersetzbar zu machen,
