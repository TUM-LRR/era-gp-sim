...
// permute the bytes
  ...
  namespace standardConversions {
    const signFunction unSignum0{ conversions::detail::unSignumA };
    const signFunction Signum0{ conversions::detail::signumA };

    const toIntegralFunction nonsigned1{ conversions::detail::nonsignedB };
    const toIntegralFunction signBit1{ conversions::detail::signBitB };
    const toIntegralFunction onesComplement1{ conversions::detail::onesComplementB };
    const toIntegralFunction twosComplement1{ conversions::detail::twosComplementB };

    const toMemoryValueFunction nonsigned2{ conversions::detail::nonsignedC };
    const toMemoryValueFunction signBit2{ conversions::detail::signBitC };
    const toMemoryValueFunction onesComplement2{ conversions::detail::onesComplementC };
    const toMemoryValueFunction twosComplement2{ conversions::detail::twosComplementC };
