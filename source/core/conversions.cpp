...
// permute the bytes
  ...
  namespace {
    ...
    MemoryValue
      signBitC(const std::vector<std::uint8_t>& value, const std::size_t size, const bool sign) {
  ...
  namespace standardConversions{
    const Conversion nonsigned{ conversions::standardConversions::helper::nonsigned::signum, conversions::standardConversions::helper::nonsigned::toIntegralFunction, conversions::standardConversions::helper::nonsigned::toMemoryValueFunction};
    const Conversion signBit{ conversions::standardConversions::helper::signBit::signum, conversions::standardConversions::helper::signBit::toIntegralFunction, conversions::standardConversions::helper::signBit::toMemoryValueFunction };
    const Conversion onesComplement{ conversions::standardConversions::helper::onesComplement::signum, conversions::standardConversions::helper::onesComplement::toIntegralFunction, conversions::standardConversions::helper::onesComplement::toMemoryValueFunction };
    const Conversion twosComplement{ conversions::standardConversions::helper::twosComplement::signum, conversions::standardConversions::helper::twosComplement::toIntegralFunction, conversions::standardConversions::helper::twosComplement::toMemoryValueFunction };
  }
  namespace detail {
