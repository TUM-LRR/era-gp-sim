...
const conversions::SignFunction signum{conversions::detail::unSignumA};
/** the standard toIntegral function for unsigned conversions */
const conversions::ToIntegralFunction toIntegralFunction{
    conversions::detail::nonsignedB};
/** the standard toMemoryValue function for unsigned conversions */
const conversions::ToMemoryValueFunction toMemoryValueFunction{
    conversions::detail::nonsignedC};
}
namespace signBit {
/** the standard sign function for signed conversions */
const conversions::SignFunction signum{conversions::detail::signumA};
/** the standard toIntegral function for signed conversions using the SignBit
* SignedRepresentation
*/
const conversions::ToIntegralFunction toIntegralFunction{
    conversions::detail::signBitB};
/** the standard toMemoryValue function for signed conversions using the SignBit
* SignedRepresentation
*/
const conversions::ToMemoryValueFunction toMemoryValueFunction{
    conversions::detail::signBitC};
}
...
*/
const conversions::ToIntegralFunction toIntegralFunction{
    conversions::detail::onesComplementB};
/** the standard toMemoryValue function for signed conversions using the
* onesComplement SignedRepresentation
*/
const conversions::ToMemoryValueFunction toMemoryValueFunction{
    conversions::detail::onesComplementC};
}
...
*/
const conversions::ToIntegralFunction toIntegralFunction{
    conversions::detail::twosComplementB};
/** the standard toMemoryValue function for signed conversions using the
* twosComplement SignedRepresentation
*/
const conversions::ToMemoryValueFunction toMemoryValueFunction{
    conversions::detail::twosComplementC};
}
}
}
namespace standardConversions {
