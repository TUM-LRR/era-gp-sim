...
DataTypeInformation::DataTypeInformation(const InformationInterface::Format& data) {
  _deserialize(data);
}
...
void DataTypeInformation::_deserialize(const InformationInterface::Format& data) {
