...
TEST_F(PseudoInstructionTest, MV_32) {
  ...
  memoryAccess.setRegisterValue("x1", convert<uint32_t>(testValue));
...
TEST_F(PseudoInstructionTest, SEQZ_32) {
  ...
  ASSERT_EQ(memoryAccess.getRegisterValue("x2").get(), convert<uint32_t>(0));

  testValue = 0;
  memoryAccess.setRegisterValue("x1", convert<uint32_t>(testValue));
  testPseudoInstruction(memoryAccess, "seqz x2,x1", 1);
  ASSERT_EQ(memoryAccess.getRegisterValue("x2").get(), convert<uint32_t>(1));
}
...
TEST_F(PseudoInstructionTest, BEQZ_32) {
  ...
  ASSERT_EQ(memoryAccess.getRegisterValue("pc").get(), convert<uint32_t>(4));

  testValue = 0;
  memoryAccess.setRegisterValue("x1", convert<uint32_t>(testValue));
  memoryAccess.setRegisterValue("pc", convert<uint32_t>(0));
  testPseudoInstruction(memoryAccess, "beqz x1,21", 1);
  ASSERT_EQ(memoryAccess.getRegisterValue("pc").get(), convert<uint32_t>(42));
}
...
TEST_F(PseudoInstructionTest, JAL_32) {
  ...
  ASSERT_EQ(memoryAccess.getRegisterValue("pc").get(), convert<uint32_t>(42));
  ASSERT_EQ(memoryAccess.getRegisterValue("x1").get(), convert<uint32_t>(12));
}
...
TEST_F(PseudoInstructionTest, JALR_32) {
  ...
  ASSERT_EQ(memoryAccess.getRegisterValue("pc").get(),
            convert<uint32_t>(testValue));
  ASSERT_EQ(memoryAccess.getRegisterValue("x1").get(), convert<uint32_t>(4));
}
...
TEST_F(PseudoInstructionTest, CALL_32) {
  ...
  ASSERT_EQ(memoryAccess.getRegisterValue("x1").get(), convert<uint32_t>(8));
}
